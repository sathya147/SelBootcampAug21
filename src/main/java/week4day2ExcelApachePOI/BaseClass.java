...
public class BaseClass {
	...
	@Parameters({"sfurl", "sflogin", "sfpassword"})
	@BeforeMethod(onlyForGroups={"needDriver"})
	public void initiateDriverAndLogin(String argURL, String argLogin, String argPassword) {
	...
	public static String[][] provideData() throws IOException {
		System.out.println("data provider in baseclass: " +excelFileName);
		
		String[][] readData = ExcelReader.readData(excelFileName); 
		return readData;
	}
	
	@Test
	public void tempuse() {
		System.out.println("does file get assigned in Base class: " +excelFileName);
	}
